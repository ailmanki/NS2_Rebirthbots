...
kMarineBrainActions =
{
    ...
    function(bot, brain)
        ...
        if not sdb:Get("welder") and
            not kCombatVersion and -- can't get welders in combat
...
if kCombatVersion then
    ...
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Shotgun,     4.0 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Weapons1,    5.0 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Weapons2,    3.5 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Weapons3,    3.0 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.AdvancedWeaponry,        4.0 + math.random() ))
    
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Armor1,      5.0 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Armor2,      3.0 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Armor3,      3.0 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Armor3,      3.0 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Scan,        2.0 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Welder,      4.0 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.MedPack,     4.0 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.CatPack,     1.0 + math.random() ))
    
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.HeavyMachineGun,     1.0 + math.random() ))
    
    
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.Jetpack, 4.0 + math.random() ))
    table.insert(kMarineBrainActions, CreateBuyCombatUpgradeAction(kTechId.DualMinigunExosuit, 3.0 + math.random() ))
end